...
void handleUpdate(String releasePageUrl) {
  ...
  final isDirectAsset = releasePageUrl.endsWith('.exe') ||
      releasePageUrl.endsWith('.msi') ||
      releasePageUrl.endsWith('.dmg') ||
      releasePageUrl.endsWith('.deb') ||
      releasePageUrl.endsWith('.rpm') ||
