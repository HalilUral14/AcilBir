...
pub const LINK_DOCS_HOME: &str = "https://acilbir.com";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://acilbir.com";
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["acilbir.com"];
pub const RS_PUB_KEY: &str = "ctqWJG3PIl9bk3h3Obs8HPS4wRZzCuZPhsjuSlwzhpE=";
