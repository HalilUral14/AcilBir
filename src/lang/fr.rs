...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("System is up to date", "Votre système est à jour"),
        ("Current Version", "Version actuelle"),
        ("Check for Updates", "Vérifier les mises à jour"),
        ("New version found", "Nouvelle version trouvée"),
        ("current", "actuelle"),
        ("Server response could not be read", "La réponse du serveur n'a pas pu être lue"),
        ("Could not connect to update server", "Impossible de se connecter au serveur de mise à jour"),
        ("Code", "Code"),
        ("A network/system error occurred during update check", "Une erreur réseau/système s'est produite lors de la vérification des mises à jour"),
        ("AcilBir Client", "Client AcilBir"),
        ("AcilBir Support & Web Portal", "Support AcilBir & Portail Web"),
