...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "अपडेट जांच"),
        ("System is up to date", "आपका सिस्टम अपडेट है"),
        ("Current Version", "वर्तमान संस्करण"),
        ("Check for Updates", "अपडेट की जांच करें"),
        ("New version found", "नया संस्करण मिला"),
        ("current", "वर्तमान"),
        ("Server response could not be read", "सर्वर प्रतिक्रिया पढ़ी नहीं जा सकी"),
        ("Could not connect to update server", "अपडेट सर्वर से कनेक्ट नहीं हो सका"),
        ("Code", "कोड"),
        ("A network/system error occurred during update check", "अपडेट जांच के दौरान नेटवर्क/सिस्टम त्रुटि हुई"),
        ("AcilBir Client", "AcilBir क्लाइंट"),
        ("AcilBir Support & Web Portal", "AcilBir सहायता और वेब पोर्टल"),
            ("Do you want to update now?", "क्या आप अभी अपडेट करना चाहते हैं?"),
    ].iter().cloned().collect();
}
