...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "Aktualisierungsprüfung"),
        ("System is up to date", "Ihr System ist auf dem neuesten Stand"),
        ("Current Version", "Aktuelle Version"),
        ("Check for Updates", "Nach Aktualisierungen suchen"),
        ("New version found", "Neue Version gefunden"),
        ("current", "aktuell"),
        ("Server response could not be read", "Serverantwort konnte nicht gelesen werden"),
        ("Could not connect to update server", "Verbindung zum Aktualisierungsserver konnte nicht hergestellt werden"),
        ("Code", "Code"),
        ("A network/system error occurred during update check", "Bei der Aktualisierungsprüfung ist ein Netzwerk-/Systemfehler aufgetreten"),
