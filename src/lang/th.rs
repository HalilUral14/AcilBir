...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("System is up to date", "ระบบของคุณเป็นเวอร์ชันล่าสุดแล้ว"),
        ("Current Version", "เวอร์ชันปัจจุบัน"),
        ("Check for Updates", "ตรวจสอบการอัปเดต"),
        ("New version found", "พบเวอร์ชันใหม่"),
        ("current", "ปัจจุบัน"),
        ("Server response could not be read", "ไม่สามารถอ่านการตอบกลับจากเซิร์ฟเวอร์ได้"),
        ("Could not connect to update server", "ไม่สามารถเชื่อมต่อกับเซิร์ฟเวอร์อัปเดตได้"),
        ("Code", "รหัส"),
        ("A network/system error occurred during update check", "เกิดข้อผิดพลาดของเครือข่าย/ระบบระหว่างการตรวจสอบการอัปเดต"),
        ("AcilBir Client", "ไคลเอนต์ AcilBir"),
        ("AcilBir Support & Web Portal", "การสนับสนุน AcilBir และพอร์ทัลเว็บ"),
            ("Do you want to update now?", "คุณต้องการอัปเดตตอนนี้หรือไม่?"),
    ].iter().cloned().collect();
}
