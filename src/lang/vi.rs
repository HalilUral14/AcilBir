...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("System is up to date", "Hệ thống của bạn đã được cập nhật"),
        ("Current Version", "Phiên bản hiện tại"),
        ("Check for Updates", "Kiểm tra cập nhật"),
        ("New version found", "Đã tìm thấy phiên bản mới"),
        ("current", "hiện tại"),
        ("Server response could not be read", "Không thể đọc phản hồi từ máy chủ"),
        ("Could not connect to update server", "Không thể kết nối đến máy chủ cập nhật"),
        ("Code", "Mã"),
        ("A network/system error occurred during update check", "Đã xảy ra lỗi mạng/hệ thống khi kiểm tra cập nhật"),
        ("AcilBir Client", "Máy khách AcilBir"),
        ("AcilBir Support & Web Portal", "Hỗ trợ AcilBir & Cổng thông tin Web"),
            ("Do you want to update now?", "Bạn có muốn cập nhật ngay bây giờ không?"),
    ].iter().cloned().collect();
}
