...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "檢查更新"),
        ("System is up to date", "您的系統已是最新版本"),
        ("Current Version", "目前版本"),
        ("Check for Updates", "檢查更新"),
        ("New version found", "發現新版本"),
        ("current", "目前"),
        ("Server response could not be read", "無法讀取伺服器回應"),
        ("Could not connect to update server", "無法連線到更新伺服器"),
        ("Code", "代碼"),
        ("A network/system error occurred during update check", "檢查更新時發生網路/系統錯誤"),
        ("AcilBir Client", "AcilBir 用戶端"),
        ("AcilBir Support & Web Portal", "AcilBir 支援與網頁入口"),
            ("Do you want to update now?", "您現在要更新嗎？"),
    ].iter().cloned().collect();
}
