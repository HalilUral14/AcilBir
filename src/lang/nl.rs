...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("System is up to date", "Uw systeem is up-to-date"),
        ("Current Version", "Huidige versie"),
        ("Check for Updates", "Controleren op updates"),
        ("New version found", "Nieuwe versie gevonden"),
        ("current", "huidig"),
        ("Server response could not be read", "Serverreactie kon niet worden gelezen"),
        ("Could not connect to update server", "Kon geen verbinding maken met de updateserver"),
        ("Code", "Code"),
        ("A network/system error occurred during update check", "Er is een netwerk-/systeemfout opgetreden tijdens de updatecontrole"),
        ("AcilBir Client", "AcilBir Client"),
        ("AcilBir Support & Web Portal", "AcilBir Ondersteuning & Webportaal"),
            ("Do you want to update now?", "Wilt u nu bijwerken?"),
    ].iter().cloned().collect();
}
