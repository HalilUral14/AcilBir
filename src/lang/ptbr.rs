...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("System is up to date", "Seu sistema está atualizado"),
        ("Current Version", "Versão atual"),
        ("Check for Updates", "Verificar atualizações"),
        ("New version found", "Nova versão encontrada"),
        ("current", "atual"),
        ("Server response could not be read", "A resposta do servidor não pôde ser lida"),
        ("Could not connect to update server", "Não foi possível conectar ao servidor de atualização"),
        ("Code", "Código"),
        ("A network/system error occurred during update check", "Ocorreu um erro de rede/sistema durante a verificação de atualização"),
        ("AcilBir Client", "Cliente AcilBir"),
        ("AcilBir Support & Web Portal", "Suporte AcilBir & Portal Web"),
