...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "בדיקת עדכונים"),
        ("System is up to date", "המערכת שלך מעודכנת"),
        ("Current Version", "גרסה נוכחית"),
        ("Check for Updates", "בדוק עדכונים"),
        ("New version found", "נמצאה גרסה חדשה"),
        ("current", "נוכחית"),
        ("Server response could not be read", "לא ניתן לקרוא את תגובת השרת"),
        ("Could not connect to update server", "לא ניתן להתחבר לשרת העדכונים"),
        ("Code", "קוד"),
        ("A network/system error occurred during update check", "אירעה שגיאת רשת/מערכת במהלך בדיקת העדכונים"),
        ("AcilBir Client", "לקוח AcilBir"),
        ("AcilBir Support & Web Portal", "תמיכה ופורטל AcilBir"),
            ("Do you want to update now?", "האם ברצונך לעדכן כעת?"),
    ].iter().cloned().collect();
}
