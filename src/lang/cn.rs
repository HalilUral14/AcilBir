...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "检查更新"),
        ("System is up to date", "您的系统已是最新版本"),
        ("Current Version", "当前版本"),
        ("Check for Updates", "检查更新"),
        ("New version found", "发现新版本"),
        ("current", "当前"),
        ("Server response could not be read", "无法读取服务器响应"),
        ("Could not connect to update server", "无法连接到更新服务器"),
        ("Code", "代码"),
        ("A network/system error occurred during update check", "检查更新时发生网络/系统错误"),
        ("AcilBir Client", "AcilBir 客户端"),
        ("AcilBir Support & Web Portal", "AcilBir 支持和网络门户"),
            ("Do you want to update now?", "您现在要更新吗？"),
    ].iter().cloned().collect();
}
