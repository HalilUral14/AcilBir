...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Continue", "Devam Et"),
        ("Browser didn't open? Use the url below to sign in.", "Tarayıcı açılmadı mı? Giriş yapmak için aşağıdaki bağlantıyı kullanın."),
        ("Update Check", "Güncelleme Kontrolü"),
        ("System is up to date", "Sisteminiz güncel"),
        ("Current Version", "Mevcut Sürüm"),
        ("Check for Updates", "Güncellemeleri Kontrol Et"),
        ("New version found", "Yeni sürüm bulundu"),
        ("current", "mevcut"),
        ("Server response could not be read", "Sunucu yanıtı okunamadı"),
        ("Could not connect to update server", "Güncelleme sunucusuna bağlanılamadı"),
        ("Code", "Kod"),
        ("A network/system error occurred during update check", "Güncelleme kontrolü sırasında bir ağ/sistem hatası oluştu"),
        ("AcilBir Client", "AcilBir İstemcisi"),
        ("AcilBir Support & Web Portal", "AcilBir Destek & Web Portalı"),
            ("Do you want to update now?", "Şimdi güncellemek istiyor musunuz?"),
    ].iter().cloned().collect();
}
