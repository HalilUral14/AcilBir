...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "بررسی بهروزرسانی"),
        ("System is up to date", "سیستم شما بهروز است"),
        ("Current Version", "نسخه فعلی"),
        ("Check for Updates", "بررسی بهروزرسانیها"),
        ("New version found", "نسخه جدید پیدا شد"),
        ("current", "فعلی"),
        ("Server response could not be read", "پاسخ سرور قابل خواندن نیست"),
        ("Could not connect to update server", "اتصال به سرور بهروزرسانی ممکن نیست"),
        ("Code", "کد"),
        ("A network/system error occurred during update check", "خطای شبکه/سیستم هنگام بررسی بهروزرسانی رخ داد"),
        ("AcilBir Client", "کلاینت AcilBir"),
        ("AcilBir Support & Web Portal", "پشتیبانی AcilBir و پرتال وب"),
            ("Do you want to update now?", "آیا می‌خواهید اکنون به‌روزرسانی کنید؟"),
    ].iter().cloned().collect();
}
