...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "புதுப்பிப்பு சோதனை"),
        ("System is up to date", "உங்கள் கணினி புதுப்பிக்கப்பட்டது"),
        ("Current Version", "தற்போதைய பதிப்பு"),
        ("Check for Updates", "புதுப்பிப்புகளைச் சோதிக்கவும்"),
        ("New version found", "புதிய பதிப்பு கண்டுபிடிக்கப்பட்டது"),
        ("current", "தற்போதைய"),
        ("Server response could not be read", "சர்வர் பதிலை வாசிக்க முடியவில்லை"),
        ("Could not connect to update server", "புதுப்பிப்பு சர்வருடன் இணைக்க முடியவில்லை"),
        ("Code", "குறியீடு"),
        ("A network/system error occurred during update check", "புதுப்பிப்பு சோதனையின் போது நெட்வொர்க்/கணினி பிழை ஏற்பட்டது"),
        ("AcilBir Client", "AcilBir கிளையன்ட்"),
        ("AcilBir Support & Web Portal", "AcilBir ஆதரவு & வலை போர்ட்டல்"),
            ("Do you want to update now?", "இப்போது புதுப்பிக்க விரும்புகிறீர்களா?"),
    ].iter().cloned().collect();
}
