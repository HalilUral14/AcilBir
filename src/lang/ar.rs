...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "فحص التحديث"),
        ("System is up to date", "نظامك محدث"),
        ("Current Version", "الإصدار الحالي"),
        ("Check for Updates", "التحقق من التحديثات"),
        ("New version found", "تم العثور على إصدار جديد"),
        ("current", "الحالي"),
        ("Server response could not be read", "تعذر قراءة استجابة الخادم"),
        ("Could not connect to update server", "تعذر الاتصال بخادم التحديث"),
        ("Code", "الرمز"),
        ("A network/system error occurred during update check", "حدث خطأ في الشبكة/النظام أثناء فحص التحديث"),
        ("AcilBir Client", "عميل AcilBir"),
        ("AcilBir Support & Web Portal", "دعم AcilBir وبوابة الويب"),
            ("Do you want to update now?", "هل ترغب في التحديث الآن؟"),
    ].iter().cloned().collect();
}
