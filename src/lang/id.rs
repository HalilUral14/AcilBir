...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "Pemeriksaan pembaruan"),
        ("System is up to date", "Sistem Anda sudah terbaru"),
        ("Current Version", "Versi saat ini"),
        ("Check for Updates", "Periksa pembaruan"),
        ("New version found", "Versi baru ditemukan"),
        ("current", "saat ini"),
        ("Server response could not be read", "Respons server tidak dapat dibaca"),
        ("Could not connect to update server", "Tidak dapat terhubung ke server pembaruan"),
        ("Code", "Kode"),
        ("A network/system error occurred during update check", "Terjadi kesalahan jaringan/sistem saat memeriksa pembaruan"),
        ("AcilBir Client", "Klien AcilBir"),
        ("AcilBir Support & Web Portal", "Dukungan AcilBir & Portal Web"),
            ("Do you want to update now?", "Apakah Anda ingin memperbarui sekarang?"),
    ].iter().cloned().collect();
}
