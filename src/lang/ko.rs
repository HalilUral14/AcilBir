...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("System is up to date", "시스템이 최신 상태입니다"),
        ("Current Version", "현재 버전"),
        ("Check for Updates", "업데이트 확인"),
        ("New version found", "새 버전이 발견되었습니다"),
        ("current", "현재"),
        ("Server response could not be read", "서버 응답을 읽을 수 없습니다"),
        ("Could not connect to update server", "업데이트 서버에 연결할 수 없습니다"),
        ("Code", "코드"),
        ("A network/system error occurred during update check", "업데이트 확인 중 네트워크/시스템 오류가 발생했습니다"),
        ("AcilBir Client", "AcilBir 클라이언트"),
        ("AcilBir Support & Web Portal", "AcilBir 지원 및 웹 포털"),
            ("Do you want to update now?", "지금 업데이트하시겠습니까?"),
    ].iter().cloned().collect();
}
