...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "અપડેટ તપાસ"),
        ("System is up to date", "તમારી સિસ્ટમ અપડેટ છે"),
        ("Current Version", "વર્તમાન સંસ્કરણ"),
        ("Check for Updates", "અપડેટ્સ તપાસો"),
        ("New version found", "નવું સંસ્કરણ મળ્યું"),
        ("current", "વર્તમાન"),
        ("Server response could not be read", "સર્વર પ્રતિસાદ વાંચી શકાયો નહીં"),
        ("Could not connect to update server", "અપડેટ સર્વર સાથે કનેક્ટ થઈ શક્યું નહીં"),
        ("Code", "કોડ"),
        ("A network/system error occurred during update check", "અપડેટ તપાસ દરમિયાન નેટવર્ક/સિસ્ટમ ભૂલ આવી"),
        ("AcilBir Client", "AcilBir ક્લાયન્ટ"),
        ("AcilBir Support & Web Portal", "AcilBir સપોર્ટ અને વેબ પોર્ટલ"),
            ("Do you want to update now?", "શું તમે હમણાં અપડેટ કરવા માંગો છો?"),
    ].iter().cloned().collect();
}
