...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("New version found", "Nuova versione trovata"),
        ("current", "corrente"),
        ("Server response could not be read", "Impossibile leggere la risposta del server"),
        ("Could not connect to update server", "Impossibile connettersi al server di aggiornamento"),
        ("Code", "Codice"),
        ("A network/system error occurred during update check", "Si è verificato un errore di rete/sistema durante il controllo degli aggiornamenti"),
        ("AcilBir Client", "Client AcilBir"),
        ("AcilBir Support & Web Portal", "Supporto AcilBir e Portale Web"),
            ("Do you want to update now?", "Vuoi aggiornare ora?"),
    ].iter().cloned().collect();
}
