...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "അപ്ഡേറ്റ് പരിശോധന"),
        ("System is up to date", "നിങ്ങളുടെ സിസ്റ്റം അപ്ഡേറ്റ് ആണ്"),
        ("Current Version", "നിലവിലെ പതിപ്പ്"),
        ("Check for Updates", "അപ്ഡേറ്റുകൾ പരിശോധിക്കുക"),
        ("New version found", "പുതിയ പതിപ്പ് കണ്ടെത്തി"),
        ("current", "നിലവിലെ"),
        ("Server response could not be read", "സെർവർ പ്രതികരണം വായിക്കാൻ കഴിഞ്ഞില്ല"),
        ("Could not connect to update server", "അപ്ഡേറ്റ് സെർവറിലേക്ക് കണക്ട് ചെയ്യാൻ കഴിഞ്ഞില്ല"),
        ("Code", "കോഡ്"),
        ("A network/system error occurred during update check", "അപ്ഡേറ്റ് പരിശോധനയ്ക്കിടെ നെറ്റ്വർക്ക്/സിസ്റ്റം പിശക് സംഭവിച്ചു"),
        ("AcilBir Client", "AcilBir ക്ലയന്റ്"),
        ("AcilBir Support & Web Portal", "AcilBir പിന്തുണയും വെബ് പോർട്ടലും"),
            ("Do you want to update now?", "ഇപ്പോൾ അപ്‌ഡേറ്റ് ചെയ്യണോ?"),
    ].iter().cloned().collect();
}
