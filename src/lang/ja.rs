...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "更新確認"),
        ("System is up to date", "システムは最新です"),
        ("Current Version", "現在のバージョン"),
        ("Check for Updates", "更新を確認"),
        ("New version found", "新しいバージョンが見つかりました"),
        ("current", "現在"),
        ("Server response could not be read", "サーバーの応答を読み取れませんでした"),
        ("Could not connect to update server", "更新サーバーに接続できませんでした"),
        ("Code", "コード"),
        ("A network/system error occurred during update check", "更新確認中にネットワーク/システムエラーが発生しました"),
        ("AcilBir Client", "AcilBir クライアント"),
        ("AcilBir Support & Web Portal", "AcilBir サポート＆ウェブポータル"),
            ("Do you want to update now?", "今すぐ更新しますか？"),
    ].iter().cloned().collect();
}
