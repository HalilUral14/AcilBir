...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "განახლების შემოწმება"),
        ("System is up to date", "თქვენი სისტემა განახლებულია"),
        ("Current Version", "მიმდინარე ვერსია"),
        ("Check for Updates", "განახლებების შემოწმება"),
        ("New version found", "ახალი ვერსია ნაპოვნია"),
        ("current", "მიმდინარე"),
        ("Server response could not be read", "სერვერის პასუხი ვერ წაიკითხა"),
        ("Could not connect to update server", "განახლების სერვერთან დაკავშირება ვერ მოხერხდა"),
        ("Code", "კოდი"),
        ("A network/system error occurred during update check", "განახლების შემოწმებისას ქსელის/სისტემის შეცდომა მოხდა"),
        ("AcilBir Client", "AcilBir კლიენტი"),
        ("AcilBir Support & Web Portal", "AcilBir მხარდაჭერა და ვებ-პორტალი"),
            ("Do you want to update now?", "გსურთ განახლება ახლა?"),
    ].iter().cloned().collect();
}
