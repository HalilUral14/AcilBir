...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Update Check", "Verificación de actualización"),
        ("System is up to date", "Su sistema está actualizado"),
        ("Current Version", "Versión actual"),
        ("Check for Updates", "Buscar actualizaciones"),
        ("New version found", "Nueva versión encontrada"),
        ("current", "actual"),
        ("Server response could not be read", "No se pudo leer la respuesta del servidor"),
        ("Could not connect to update server", "No se pudo conectar al servidor de actualización"),
        ("Code", "Código"),
        ("A network/system error occurred during update check", "Se produjo un error de red/sistema durante la verificación de actualización"),
        ("AcilBir Client", "Cliente AcilBir"),
        ("AcilBir Support & Web Portal", "Soporte AcilBir y Portal Web"),
            ("Do you want to update now?", "¿Desea actualizar ahora?"),
    ].iter().cloned().collect();
}
