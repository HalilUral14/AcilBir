...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("current", "current"),
        ("Server response could not be read", "Server response could not be read"),
        ("Could not connect to update server", "Could not connect to update server"),
        ("Code", "Code"),
        ("A network/system error occurred during update check", "A network/system error occurred during update check"),
        ("AcilBir Client", "AcilBir Client"),
        ("AcilBir Support & Web Portal", "AcilBir Support & Web Portal"),
